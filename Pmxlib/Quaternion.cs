...
namespace PmxLib
{
	public struct Quaternion
	{
		...
		public static Quaternion RotationYawPitchRoll(float yaw, float pitch, float roll)//, out Quaternion result)
		{
			Quaternion result = default(Quaternion);
			float num = roll * 0.5f;
			...
			result.X = (float)((double)num2 * num11 + (double)num3 * num10);
			result.Y = (float)((double)num3 * num11 - (double)num2 * num10);
			double num12 = (double)num9 * (double)num6;
			double num13 = (double)num8 * (double)num5;
			result.Z = (float)((double)num2 * num12 - (double)num3 * num13);
			result.W = (float)((double)num2 * num13 + (double)num3 * num12);
			return result;
		}
	}
}
